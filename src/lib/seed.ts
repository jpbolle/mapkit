export const SEED_TITLE = "Les Sept Piliers de la Neuroéducation selon Steve Masson";

export const SEED_MARKDOWN = `# Les Sept Piliers de la Neuroéducation selon Steve Masson
